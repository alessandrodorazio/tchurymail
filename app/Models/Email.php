...
class Email extends Model
{
    ...
    public function sendEmail($variables) {
        ...
        Mail::to($this->recipient)->send(new MailDefault($content));
        $this->save();
    }
    ...
    public function constructEmailContent($variables) {
        ...
        $content = '<mjml><mj-head><mj-attributes><mj-text align="center" color="#555"/></mj-attributes></mj-head><mj-body background-color="#eee">' . $header->content . $this->template->content . $footer->content . '</mj-body></mjml>';
